<template>
  <div class="container pb-10 pb-md-20">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div
          v-if="product.imageUrl && Object.keys(product.imageUrl).length > 0"
        >
          <img
      ...
      <div class="col-md-6 sticky-md-top vh-md-100">
        <div class="ms-md-10 mt-md-8" :class="{ 'mt-md-20': hasMarginTop }">
      ...
      <div v-for="image in product.imagesUrl" :key="image" class="d-md-none">
        <img
          class="aspect-ratio-img"
          :src="image['1000w']"
          alt="其他圖片"
